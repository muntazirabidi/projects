...
ax.set_aspect('equal')
circle = plt.Circle((0, 0), 1, fill=False, ls='dashed', color='gray', alpha=0.9, lw=2)
ax.add_artist(circle)

# Add a title and axis labels
plt.title('Uniform Circular Motion', fontsize=16)
plt.xlabel('x')
plt.ylabel('y')
...
ani.save("circular_motion.gif", writer=writer)
